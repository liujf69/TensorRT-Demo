...
def get_parser():
    ...
    parser.add_argument(
        '--onnx',
        type = str,
        default = './model/Dynamics_linear.onnx')
    return parser
...
class build_engine():
    ...
    def onnx2engine(self):
        ...
        profile.set_shape("input", (1, 1), (3, 1), (5, 1))  # 设置动态输入,分别对应:最小尺寸、最佳尺寸、最大尺寸
...
if __name__ == "__main__":
    ...
    Batch_size = args.b
    Channel = args.c
    input_data = torch.ones((Batch_size, Channel))
    ...
    # 绑定上下文
    B, C = input_data.shape
    context.set_binding_shape(engine.get_binding_index("input"), (B, 1))
    ...
    # 后处理
    print(output_buffer) # 打印结果，验证推理结果
